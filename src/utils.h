...
void bounds(const char *file, int line, const std::string &str, bigint nmin, bigint nmax, TYPE &nlo,
            TYPE &nhi, Error *error, int failed = -2);    // -2 = Error::NOPOINTER
...
void bounds_typelabel(const char *file, int line, const std::string &str, bigint nmin, bigint nmax,
                      TYPE &nlo, TYPE &nhi, LAMMPS *lmp, int mode);
